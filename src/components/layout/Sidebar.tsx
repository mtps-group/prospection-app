...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex w-72 flex-col bg-white dark:bg-[#15102e] border-r border-gray-100 dark:border-violet-500/10 transition-transform duration-300 lg:translate-x-0 lg:static lg:z-auto',
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-6">
          ...
          <button onClick={onClose} className="lg:hidden text-text-secondary hover:text-text rounded-lg p-1.5 hover:bg-gray-100 dark:hover:bg-violet-500/10">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <nav className="flex-1 px-4 py-3 space-y-1">
          ...
          <Link
            href="/"
            onClick={onClose}
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-text-muted hover:bg-gray-50 dark:hover:bg-violet-500/10 hover:text-text transition-all mb-3"
          >
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : isLocked
                    ? 'text-text-muted hover:bg-gray-50 dark:hover:bg-violet-500/10 opacity-70'
                    : 'text-text-secondary hover:bg-gray-50 dark:hover:bg-violet-500/10 hover:text-text'
                )}
              >
                <div className={cn(
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-gray-100 dark:bg-white/5 text-text'
                    : 'text-text-muted hover:bg-gray-50 dark:hover:bg-violet-500/10 hover:text-text-secondary'
                )}
              >
        ...
        <div className="p-4">
          {profile?.plan === 'free' ? (
            <div className="rounded-2xl bg-gradient-to-br from-primary/5 to-purple-500/5 dark:from-primary/15 dark:to-purple-500/15 border border-primary/10 dark:border-primary/30 p-4">
              ...
              <div className="h-1.5 rounded-full bg-gray-200 dark:bg-white/5 overflow-hidden mb-3">
                <div
