        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-3xl bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border border-green-200/60 p-10 flex flex-col sm:flex-row items-center gap-10">
            <div className="flex-1 text-center sm:text-left">
              ...
              <h3 className="text-2xl font-extrabold text-text mb-3">1 seul client signé = 12 mois d&apos;abonnement</h3>
              <p className="text-text-secondary leading-relaxed">
                Un site vitrine se vend entre <strong className="text-text">600€ et 1 500€</strong>. Avec un abonnement à 49€/mois,
