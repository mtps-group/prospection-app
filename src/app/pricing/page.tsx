...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Fonctionnalites IA', included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Fiche IA de l\'entreprise', included: true },
      { text: 'Recherche email par IA', included: true },
      { text: 'Email de prospection IA (methode PAS)', included: true },
